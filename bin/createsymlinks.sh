...
links=(".screenrc" ".bash_aliases" "bin" ".vim" ".vimrc" ".i3" ".highlight" ".grc" ".nticon.conf" ".dircolors" ".compton.conf" ".config/vifm" ".config/mpv" ".config/neofetch" ".config/pnmixer" ".config/redshift" ".gnokiirc")
