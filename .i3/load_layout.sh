...
(x-terminal-emulator -title TerminalDmesg -e sh -c 'env PROMPT_COMMAND="unset PROMPT_COMMAND; sudo dmesg -wt" bash') &
(x-terminal-emulator -title TerminalShownetstat -e sh -c 'env PROMPT_COMMAND="unset PROMPT_COMMAND; shownetstat" bash') &
(x-terminal-emulator -title TerminalWork -e bash -c 'env PROMPT_COMMAND="unset PROMPT_COMMAND; vifm" bash') &
